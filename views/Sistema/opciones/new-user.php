...
echo '<div class="modal fade" id="modalFormNuevoUsuario" tabindex="-1" role="dialog" aria-hidden="true">
              ...
              <div class="tile-body">
                <form id="formRol" name="formRol">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="txtdni" name="txtnombre" placeholder="ingresa el DNI" required="">
                  </div>
                  <div class="form-group">
