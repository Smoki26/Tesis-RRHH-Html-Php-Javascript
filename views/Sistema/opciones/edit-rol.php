<?php
echo '<div class="modal fade" id="modalFormEditarRol" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="tile-body">
            <form id="formRol" name="formRol">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="txtnombre" name="txtnombre" placeholder="ingresa el Rol" required="">
              </div>
              <div class="form-group">
