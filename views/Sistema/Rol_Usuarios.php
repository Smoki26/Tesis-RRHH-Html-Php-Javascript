...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div>
          <h1>&nbsp;&nbsp;<i class="fa fa fa-users"></i> Roles de Usuarios &nbsp;
            <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalFormNuevoRol"><i class="fa fa-plus-circle" aria-hidden="true"></i> Nuevo</button>
              ...
              <div class="card-body">
                ...
                <thead>
                    ...
                    <tr>
                      ...
                      <td class="col-1">
                        <div >
                          <button class="btn btn-secondary btn-xs btnPermisosRol" rl="'1'" title="Permisos" type="button" data-toggle="modal" data-target="#modalFormEditarPermisos"><i class="fa fa-unlock-alt"></i></button>
                          <button class=" btn btn-primary btn-xs btnEditRol" rl="'1'" title="Editar" type="button" data-toggle="modal" data-target="#modalFormEditarRol"><i class="fa fa-pencil-alt"></i></button>
...
<?php
include("../views/Sistema/opciones/new-rol.php");
include("../views/Sistema/opciones/edit-rol.php");
include("../views/Sistema/opciones/edit-permiso-rol.php");
?>
